...
export function Exhibition({ children, ...props }: RootExhibitionProps) {
  ...
  const contextValue = useMemo(
    ...
    [isDesktop, Comp, Trigger, Close, Content, Header, Title, Footer, Description],
  )
...
export function ExhibitionTrigger({ children, className, ...props }: ExhibitionProps) {
...
export function ExhibitionClose({ children, className, ...props }: ExhibitionProps) {
...
export function ExhibitionContent({ children, className, ...props }: ExhibitionProps) {
...
export function ExhibitionHeader({ children, className, ...props }: ExhibitionProps) {
...
export function ExhibitionTitle({ children, className, ...props }: ExhibitionProps) {
...
export function ExhibitionBody({ children, className, ...props }: ExhibitionProps) {
  return (
...
export function ExhibitionFooter({ children, className, ...props }: ExhibitionProps) {
  ...
  return (
    <Exhibition>
      <ExhibitionTrigger asChild>
        <button className="btn border-accent border rounded-md p-2" type="button">
          组件打开弹窗
        </button>
      </ExhibitionTrigger>
      <ExhibitionContent>
        ...
        <ExhibitionBody>
          <p>
            This component is built using shadcn/ui&apos;s dialog and drawer component,
            which is built on top of Vaul.
          </p>
        </ExhibitionBody>
        <ExhibitionFooter>
